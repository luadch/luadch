...
-- however, this is not a problem, because if you change the certificate of the hub, you need to restart the whole hub anyway, so the script gets executed, and the new keyprint will be calculated
